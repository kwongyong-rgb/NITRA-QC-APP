...
const STR = {
  ...
  restoreBtn:     { en: 'Restore device copy', zh: '恢复本设备版本' },
  restoreDiscard: { en: 'Keep server copy', zh: '保留服务器版本' },
  restoreSavedAt: { en: 'Device copy saved', zh: '本设备版本保存于' },
  restoreDiffTitle: { en: 'What’s different', zh: '差异内容' },
  ...
  editLotSize:    { en: 'Edit lot size', zh: '修改批量' },
  editLotSizeHint:{ en: 'The appearance and functional sample sizes are recalculated from the sampling standard for the new lot size.', zh: '外观与功能抽样数量将根据新批量按抽样标准重新计算。' },
